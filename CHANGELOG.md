...
- `CoveredByGeomConstraint` now includes a `description`, which should provide some information to help the user know
  broadly where the geometry constraint
  is ([#317](https://gitlab.heigit.org/climate-action/climatoology/-/work_items/317))
...
- a problem (for some libraries) in the created PMTiles that contained invalid JSON metadata by only writing known
  columns to the output ([#304](https://gitlab.heigit.org/climate-action/climatoology/-/work_items/304))
...
- Nullable input parameters are now also front-end compatible, if they have constraints

## [7.1.2](https://gitlab.heigit.org/climate-action/climatoology/-/releases/7.1.2) - 2026-04-16
...
- add indices to migration that have been added to celery tables in latest celery
  version [5.6.3](https://github.com/celery/celery/releases/tag/v5.6.3)

## [7.1.0](https://gitlab.heigit.org/climate-action/climatoology/-/releases/7.1.0) - 2026-03-31
...
The changelog contains subsections for changes that affect a dedicated domain.
