...
class BackendDatabase:
    ...
    def write_info(self, info: PluginInfoFinal) -> str:
    ...
    def _synch_info_to_db(self, info: PluginInfoFinal, session: Session) -> str:
    ...
    def read_info(self, plugin_id: str, plugin_version: Version = None) -> PluginInfoFinal:
        ...
        with Session(self.engine) as session:
            ...
            retrieved_info = PluginInfoFinal.model_validate(result)
